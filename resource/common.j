...
type functionalChild                extends handle
...
constant native ConvertFunctionalChild                  takes integer i returns functionalChild
...
//===================================================
    ...
    //constant controlstyleflag       CONTROL_STYLE_SLIDERSTEP             = ConvertControlStyleFlag(512)
    constant controlstyleflag       CONTROL_STYLE_EXCLUSIVE              = ConvertControlStyleFlag(512)
    //constant controlstyleflag       CONTROL_STYLE_ATLEASTONE             = ConvertControlStyleFlag(1024)

    // Icon(_Off, _PUSH) used by most Frames all that inherit CControl or CSimpleButton for sure.
    // they depend on frametype of targeted frame
    constant functionalChild       FUNC_CHILD_ICON                      = ConvertFunctionalChild(0)
    constant functionalChild       FUNC_CHILD_ICON_OFF                  = ConvertFunctionalChild(1)
    constant functionalChild       FUNC_CHILD_ICON_PUSH                 = ConvertFunctionalChild(2)

    constant functionalChild       FUNC_CHILD_LIGHT_FOCUS               = ConvertFunctionalChild(3)
    constant functionalChild       FUNC_CHILD_LIGHT_HOVER               = ConvertFunctionalChild(4)

    constant functionalChild       FUNC_CHILD_GTB_TEXT                  = ConvertFunctionalChild(5)

    constant functionalChild       FUNC_CHILD_SB_TEXT                   = ConvertFunctionalChild(3)
    constant functionalChild       FUNC_CHILD_SB_TEXT_OFF               = ConvertFunctionalChild(4)
    constant functionalChild       FUNC_CHILD_SB_TEXT_HIGH              = ConvertFunctionalChild(5)

    constant functionalChild       FUNC_CHILD_CHECKED                   = ConvertFunctionalChild(5)
    constant functionalChild       FUNC_CHILD_CHECKED_OFF               = ConvertFunctionalChild(6)

    constant functionalChild       FUNC_CHILD_SCB_BUTTON                = ConvertFunctionalChild(5)
    constant functionalChild       FUNC_CHILD_SCB_BUTTON_INC            = ConvertFunctionalChild(6)
    constant functionalChild       FUNC_CHILD_SCB_BUTTON_DEC            = ConvertFunctionalChild(7)
    
    // copied from Unryze with corner -> Border
    ...
    constant integer                     ALPHA_MOD_DISABLE                                           = 0
    constant integer                     ALPHA_MOD_ALPHAKEY                                          = 1
    constant integer                     ALPHA_MOD_BLEND                                             = 2
    constant integer                     ALPHA_MOD_ADD                                               = 3
...
native CeSetFrameBackdropBorderFlag             takes framehandle whichFrame, integer flags returns nothing     
native CeGetFrameBackdropBorderFlag             takes framehandle whichFrame returns integer
native CeGetFrameFunctionalChild                takes framehandle whichFrame, integer class  returns framehandle
native CeGetFrameAlphaMod                       takes framehandle whichFrame returns integer
native CeSetFrameAlphaMod                       takes framehandle whichFrame, integer newValue returns nothing
